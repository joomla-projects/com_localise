 ...
 * @since       1.0
 */
class LocaliseViewRemotes extends JViewLegacy
{
	protected $items;
	...
	protected function prepareDocument()
	{
		...
		$document->setTitle(JText::sprintf('COM_LOCALISE_TITLE', JText::_('COM_LOCALISE_TITLE_REMOTES')));
	}
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::sprintf('COM_LOCALISE_HEADER_MANAGER', JText::_('COM_LOCALISE_HEADER_REMOTES')), 'comments-2 langmanager');

		if ($canDo->get('localise.create'))
		{
			// JToolbarHelper::addNew('remote.add', 'COM_LOCALISE_NEW_REMOTE');
		}

		$bar = JToolbar::getInstance('toolbar');
		$title = 'Fetch remotes';
		$dhtml = "<button class='btn btn-small' onclick='fetchRemotes();'>"
		...
		JToolBarHelper::help('screen.remotes', true);
	}
